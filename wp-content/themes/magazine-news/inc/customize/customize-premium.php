...
***********************************************************************************/
		...
		function magazine_news_prmeium_customize($wp_customize){
			class magazine_news_premium_Customize extends WP_Customize_Control {
				...
				<div class="magazine_news-info"> 
						<a class="sv-info" href="<?php echo esc_url( 'https://seosthemes.com/magazine-news/' ); ?>" title="<?php esc_attr_e( 'Magazine News Pro Feature', 'magazine-news' ); ?>" target="_blank">
						<i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
						<?php _e( 'Magazine News Pro Feature', 'magazine-news' ); ?>
						</a>
						</a>
						<br /><br /><a href="<?php echo esc_url( 'http://seosthemes.info/magazine-news-free-wordpress-theme/' ); ?>" title="<?php esc_attr_e( 'Check demo here.', 'magazine-news' ); ?>" target="_blank">
						<i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
						<?php _e( 'Check demo here', 'magazine-news' ); ?>					
				</div>
				<?php
				}
			}
		...
		if ( ! function_exists( 'magazine_news_buy_option' ) ) :
			function magazine_news_buy_option( $wp_customize ) {
				...
				'title'			=> __('Magazine News Pro Feature', 'magazine-news'),
